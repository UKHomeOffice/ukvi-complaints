...
if [[ ${KUBE_NAMESPACE} == ${BRANCH_ENV} ]]; then
  ...
  $kd -f kube/app/networkpolicy-internal.yml -f kube/app/ingress-interal.yml
...
if [[ ${KUBE_NAMESPACE} == ${BRANCH_ENV} ]]; then
  echo "UAT Branch - ukvic-$DRONE_SOURCE_BRANCH.internal.$BRANCH_ENV.homeoffice.gov.uk"
fi
