@feature @biometric-residence-permit

Feature: Biometric residence permits (BRPs)

  Scenario: I am on the biometric residence permits (BRPs) (biometric-residence-permit) journey, I am acting on behalf
            of myself and want to complain in the uk that the permit has not arrived.
    ...
    Then I check 'reason-biometric-residence-permit'
    Then I select 'Continue'
    Then I should be on the 'biometric-residence-permit' page showing 'What is the problem with the BRP?'
    Then I check 'biometric-residence-permit-card-not-arrived'
    Then I select 'Continue'
    Then I should be on the 'card-not-arrived' page showing 'If a BRP card has not arrived'
  ...
  Scenario: I am on the biometric residence permits (BRPs) (biometric-residence-permit) journey, I am acting on behalf
            of myself and want to complain in the uk that the permit is not correct.
    ...
    Then I select 'Continue'
    Then I should be on the 'biometric-residence-permit' page showing 'What is the problem with the BRP?'
    Then I check 'biometric-residence-permit-card-incorrect'
    Then I select 'Continue'
    Then I should be on the 'card-incorrect' page showing 'If a BRP card is incorrect'
    Then I select 'Continue making your complaint' link
    Then I should be on the 'application-ref-numbers' page showing 'Which, if any, of the following reference numbers do you have?'
    Then I check 'reference-numbers-gwf'
    Then I fill 'gwf-reference' with ' GWF012345678'
  ...
  Scenario: I am on the biometric residence permits (BRPs) (biometric-residence-permit) journey, I am a legal
            representative and want to complain in the uk about something else.
            On the confirm page I want to change the complaint reason and complaint details.
    Given I start the 'reason' application journey
    Then I should see 'What is the complaint about?' on the page
    Then I check 'reason-biometric-residence-permit'
    Then I select 'Continue'
    Then I should be on the 'biometric-residence-permit' page showing 'What is the problem with the BRP?'
    Then I check 'biometric-residence-permit-complain-brp'
    Then I select 'Continue'
    Then I should be on the 'application-ref-numbers' page showing 'Which, if any, of the following reference numbers do you have?'
    Then I check 'reference-numbers-gwf'
    Then I fill 'gwf-reference' with ' GWF012345678'
  ...
  Scenario: I am on the biometric residence permits (BRPs) (biometric-residence-permit) journey, I am a legal
            representative and want to complain in the uk that the permit has not arrived.
  ...
  Scenario: I am on the biometric residence permits (BRPs) (biometric-residence-permit) journey, I am a relative or
            friend of the applicant and want to complain in the uk that the permit is not correct.
  ...
  Scenario: I am on the biometric residence permits (BRPs) (biometric-residence-permit) journey, I provide expert
            support or technical assistance of applicant and want to complain in the uk about 'something else'.
