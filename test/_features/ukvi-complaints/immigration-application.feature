@feature @immigration-application
Feature: Submitting an application

  Scenario: I am on the submitting an application (immigration-application) journey, I am acting on behalf of myself and
  want to complain about having technical issues with the website or payments.
  On the confirm page I want to change the complaint type and problem with the application process.
    Given I start the 'reason' application journey
    Then I should see 'What is the complaint about?' on the page
    Then I check 'reason-immigration-application'
    Then I select 'Continue'
    Then I should be on the 'immigration-application' page showing 'What was the problem with the application process?'
    Then I check 'immigration-application-technical-issues'
    Then I select 'Continue'
    Then I should be on the 'application-technical' page showing 'Where did you make your application?'
    Then I check 'where-applied-from-inside-uk'
    Then I select 'Continue'
    Then I should be on the 'application-technical-inside-uk' page showing 'If there were technical issues with the website or payments'
    ...
    # Change Problem with the Application Process
    ...
    # Change Complaint Reason to 'Unclear or misleading guidance'
    Then I select change link 'immigration-application-change-'
    Then I should see 'What was the problem with the application process?' on the page
    Then I check 'immigration-application-guidance'
    Then I select 'Continue'
    Then I should be on the 'application-guidance-where/edit' page showing 'Where did you make your application?'
    Then I check 'where-applied-from-inside-uk'
    Then I select 'Continue'
    Then I should be on the 'application-guidance-inside-uk/edit' page showing 'If the guidance was unclear or misleading'
    Then I select 'Continue making your complaint' link
    Then I should be on the 'confirm' page showing 'Check your answers'
    Then I should see 'The reason for the complaint' and 'Submitting an application' on the page
  ...
  Scenario: I am on the submitting an application (immigration-application) journey, I am acting on behalf of myself and
  want to complain in the uk about unclear or misleading guidance.
  On the confirm page I want to change the complaint type and problem with the application process.
    Given I start the 'reason' application journey
    Then I should see 'What is the complaint about?' on the page
    Then I check 'reason-immigration-application'
    ...
    Then I check 'immigration-application-guidance'
    Then I select 'Continue'
    Then I should be on the 'application-guidance-where' page showing 'Where did you make your application?'
    Then I check 'where-applied-from-inside-uk'
    Then I select 'Continue'
    Then I should be on the 'application-guidance-inside-uk' page showing 'If the guidance was unclear or misleading'
    Then I select 'Continue making your complaint' link
    Then I should be on the 'application-ref-numbers' page showing 'Which, if any, of the following reference numbers do you have?'
    Then I check 'reference-numbers-gwf'
    Then I fill 'gwf-reference' with 'GWF012345678'
    ...
    # Change Complaint Reason to 'Something else'
    Then I select change link 'immigration-application-change-'
    Then I should see 'What was the problem with the application process?' on the page
    Then I check 'immigration-application-complain'
    Then I select 'Continue'
    Then I should be on the 'confirm' page showing 'Check your answers'
    Then I should see 'The reason for the complaint' and 'Submitting an application' on the page
    Then I should see 'Problem with the application process' and 'Something else' on the page
    Then I should see 'GWF number' and 'GWF012345678' on the page
    Then I should see 'Complaint details' and 'Details of a complaint' on the page
    Then I should see 'Full name' and 'Person A' on the page
    Then I should see 'Country of nationality' and 'British Overseas Citizen' on the page
  ...
  Scenario: I am on the submitting an application (immigration-application) journey, I am a legal representative and
  want to complain in the uk about having technical issues with the website or payments.
  ...
  Scenario: I am on the submitting an application (immigration-application) journey, I am a relative or friend of
  applicant and want to complain about something else in the uk.
