@feature @immigration-appointment
Feature: Making an appointment

  Scenario: I am on the making an appointment (immigration-appointment) journey, I am acting on behalf of myself and
  want to complain in the uk about a difficulty getting an appointment.
  On the confirm page I want to change the complaint type and GWF number.
    Given I start the 'reason' application journey
    Then I should see 'What is the complaint about?' on the page
    Then I check 'reason-immigration-appointment'
    Then I select 'Continue'
    Then I should be on the 'immigration-appointment' page showing 'What problem did you have making an appointment?'
    Then I check 'immigration-appointment-lack-availability'
    Then I select 'Continue'
    Then I should be on the 'lack-availability' page showing 'Where did you make your application?'
    Then I check 'where-applied-from-inside-uk'
    Then I select 'Continue'
    Then I should be on the 'lack-availability-inside' page showing 'If it was hard to get an appointment in the UK'
    ...
    Then I should see 'The reason for the complaint' and 'Making an appointment' on the page
  ...
  Scenario: I am on the making an appointment (immigration-appointment) journey, I am acting on behalf of myself and
  want to complain in the uk about difficulty changing an appointment.
  On the confirm page I want to change the complaint type and complaint details.
    ...
    Then I select 'Continue'
    Then I should be on the 'immigration-appointment' page showing 'What problem did you have making an appointment?'
    Then I check 'immigration-appointment-change-appointment'
    Then I select 'Continue'
    Then I should be on the 'change-appointment' page showing 'Where did you make your application?'
    Then I check 'where-applied-from-inside-uk'
    Then I select 'Continue'
    Then I should be on the 'change-appointment-inside' page showing 'If you want to change your appointment'
    Then I select 'Continue making your complaint' link
    Then I should be on the 'application-ref-numbers' page showing 'Which, if any, of the following reference numbers do you have?'
    Then I check 'reference-numbers-gwf'
    Then I fill 'gwf-reference' with 'GWF012345678'
  ...
  Scenario: I am on the making an appointment (immigration-appointment) journey, I am a legal representative and
  want to complain in the uk about having technical issues with booking an appointment
  On the confirm page I want to change the legal representative to I am a sponsor, and my representatives contact details.
    ...
    Then I select 'Continue'
    Then I should be on the 'immigration-appointment' page showing 'What problem did you have making an appointment?'
    Then I check 'immigration-appointment-technical-appointments'
    Then I select 'Continue'
    Then I should be on the 'appointment-technical' page showing 'Where did you make your application?'
    Then I check 'where-applied-from-inside-uk'
    Then I select 'Continue'
    Then I should be on the 'appointment-technical-inside' page showing 'If there were technical issues with booking an appointment'
    Then I select 'Continue making your complaint' link
    Then I should be on the 'application-ref-numbers' page showing 'Which, if any, of the following reference numbers do you have?'
    Then I check 'reference-numbers-gwf'
    Then I fill 'gwf-reference' with 'GWF012345678'
  ...
  Scenario: I am on the making an appointment (immigration-appointment) journey, I am a relative or friend of
  applicant and I have a question about my appointment in the uk.
  On the confirm page I want to change the applicants name, nationality and date of birth.
    ...
    Then I select 'Continue'
    Then I should be on the 'immigration-appointment' page showing 'What problem did you have making an appointment?'
    Then I check 'immigration-appointment-questions-appointments'
    Then I select 'Continue'
    Then I should be on the 'questions-appointments' page showing 'Where did you make your application?'
    Then I check 'where-applied-from-inside-uk'
    Then I select 'Continue'
    Then I should be on the 'questions-appointments-inside' page showing 'If you have questions about your appointment'
    Then I select 'Continue making your complaint' link
    Then I should be on the 'application-ref-numbers' page showing 'Which, if any, of the following reference numbers do you have?'
    Then I check 'reference-numbers-gwf'
    Then I fill 'gwf-reference' with 'GWF012345678'
  ...
  Scenario: I am on the making an appointment (immigration-appointment) journey, I provide expert support or
  technical assistance of applicant and I have a problem with 'something else' in the uk.
  On the confirm page I want to change the complaint type
    ...
    Then I select 'Continue'
    Then I should be on the 'immigration-appointment' page showing 'What problem did you have making an appointment?'
    Then I check 'immigration-appointment-complain-appointments'
    Then I select 'Continue'
    Then I should be on the 'application-ref-numbers' page showing 'Which, if any, of the following reference numbers do you have?'
    Then I check 'reference-numbers-gwf'
    Then I fill 'gwf-reference' with 'GWF012345678'
