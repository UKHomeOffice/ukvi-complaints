@feature @immigration-decision
Feature: A negative or positive decision

  Scenario: I am on the negative or positive decision (immigration-decision) journey, I am acting on behalf of myself
            and want to complain about a positive decision on an application in the uk.
    ...
    Then I check 'reason-immigration-decision'
    Then I select 'Continue'
    Then I should be on the 'decision-outcome' page showing 'Was the decision negative or positive?'
    Then I check 'decision-outcome-positive'
    Then I select 'Continue'
    Then I should be on the 'positive-outcome-where' page showing 'Where did you make the application?'
    Then I check 'where-applied-from-inside-uk'
    Then I select 'Continue'
    Then I should be on the 'positive-outcome-inside' page showing 'If you have questions about a positive decision'
  ...
  Scenario: I am on the negative or positive decision (immigration-decision) journey, I am acting on behalf of myself
            and want to complain about a negative decision on an application in the uk.
    ...
    Then I select 'Continue'
    Then I should be on the 'decision-outcome' page showing 'Was the decision negative or positive?'
    Then I check 'decision-outcome-negative'
    Then I select 'Continue'
    Then I should be on the 'negative-outcome' page showing 'If you have questions about a negative decision'
    Then I select 'Continue making your complaint' link
    Then I should be on the 'application-ref-numbers' page showing 'Which, if any, of the following reference numbers do you have?'
    Then I check 'reference-numbers-gwf'
    Then I fill 'gwf-reference' with ' GWF012345678'
  ...
  Scenario: I am on the negative or positive decision (immigration-decision) journey, I am a legal representative and
            want to complain about a positive decision in the uk.
            On the confirm page I want to change the complaint reason and complaint details.
    Given I start the 'reason' application journey
    Then I should see 'What is the complaint about?' on the page
    Then I check 'reason-immigration-decision'
  ...
  Scenario: I am on the negative or positive decision (immigration-decision) journey, I am a legal representative and
            want to complain about a negative decision in the uk.
  ...
  Scenario: I am on the negative or positive decision (immigration-decision) journey, I am a relative or friend of
            the applicant and want to complain about a positive decision in the uk.
