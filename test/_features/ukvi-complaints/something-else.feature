@feature @other-complaint

Feature: Something else

  Scenario: I am on the something else (other-complaint) journey, I am acting on behalf of myself and
  want to complain about 'something else'.
  On the confirm page I want to change the complaint type, applicants name, nationality, and date of birth.
    ...
    Then I check 'reason-other-complaint'
    ...
    Then I should see 'The reason for the complaint' and 'Something else' on the page
    ...
    # Change Problem Complaint Reason
  ...
  Scenario: I am on the Something else (other-complaint) journey, (other-complaint) journey, I am acting on behalf of myself and
  want to complain about 'something else'.
  ...
  Scenario: I am on the Something else (other-complaint) journey, (other-complaint) journey,  I am a legal representative
  and want to complain about 'something else'.
