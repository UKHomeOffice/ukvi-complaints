...
Feature: Poor information or staff behaviour
  ...
  On the confirm page I want to change the complaint type and reference number.
    ...
    Then I should be on the 'poor-info-or-behaviour' page showing 'What was the problem?'
    Then I check 'poor-info-or-behaviour-poor-information'
    Then I select 'Continue'
    ...
    Then I should see 'The reason for the complaint' and 'Poor information or staff behaviour' on the page
  ...
  On the confirm page I want to change the complaint reason and reference number.
    ...
    Then I select 'Continue'
    Then I should be on the 'poor-info-or-behaviour' page showing 'What was the problem?'
    Then I check 'poor-info-or-behaviour-staff-behaviour'
    Then I select 'Continue'
